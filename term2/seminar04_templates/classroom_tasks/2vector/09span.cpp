...
/*
    Задачи:
        ...
        1)  Напишите функцию inc, которая будет принимать std::span<int> и увеличивать все его элементы на 1.
            Протестируйте эту функцию в main передав ей вектор v и массив a.

        2)  Напишите функцию getMax, которая будет брать на вход std::span<int>
            и возвращать максимальный элемент на диапазоне, заданом этим объектом.
            Данная функция должна работь с векторами и массивами.
*/