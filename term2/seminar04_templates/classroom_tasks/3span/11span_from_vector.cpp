...
/*
    1) Напишите функцию, которая будет прибавлять ко всем элементам вектора 1, используя std::span

    2) Напишите функцию, которая будет обращать вектор, используя span
*/