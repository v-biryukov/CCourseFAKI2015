...
/*
    ...
    Рассмотрим, например, глобальную переменную cout, определённую в iostream в пространстве имён std.
    ...
    Например это выражение:   cout << "Hello " << "World" << "\n";
        ...
        1)  Сначала напечатается "Hello " и на за место  cout << "Hello "  подставится  cout
            Получтся cout << "World" << "\n";

        2)  Потом напечатется "World" и и на за место  cout << "World"  подставится  cout
            Получтся cout << "\n";
...
/*
    Задачи:
        ...
        1)  Напечатайте на экран число 1.4, используя cout
