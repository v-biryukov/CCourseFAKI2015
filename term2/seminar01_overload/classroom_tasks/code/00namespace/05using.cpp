/*
    ...
    Если вам очень не хочется постоянно писать названия пространства имён, то вы можете использовать
    ключевое слово using вот так:

        using namespace audio;

    Это говорит о том, что начиная с этой строки, audio:: перед именами писать больше не нужно.

    Это, конечно, полностью уничтожает всю пользу, которую приносят пространства имён.
    То есть в больших проектах могут возникнуть ошибки, связанные с одинаковыми именами.

    Поэтому так лучше не делать, а если и делать, то только в маленьких программах.
*/
