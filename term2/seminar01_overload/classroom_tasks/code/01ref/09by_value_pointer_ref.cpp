/* 
    ...
    Рассмотрим три функции
        ...
        В этом случае внутри функции создаётся указатель, и в этот указатель мы передаём адрес нашего объекта.
...
/* 
    ...
    2)  Написать функции: 
        ...
        swapByReference(int& pa, int& pb) - принимает 2 числа по ссылке и обменивает их значения
