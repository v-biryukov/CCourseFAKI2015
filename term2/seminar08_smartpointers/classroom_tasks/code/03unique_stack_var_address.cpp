/*
    ...
    В этом примере создаётся умный указатель, хранящий адрес переменной, расположенной на стеке.
...
/*
    Задача 1: 
        ...
        Можно ли в умном указателе хранить nullptr то есть написать так:
