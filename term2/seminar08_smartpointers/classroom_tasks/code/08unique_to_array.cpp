/*
    Умный указатель на массив объектов:
    ...
    Но если очень нужно, то можно и создать указатель на массив объектов в куче (аналог int* p = new int[N];)
    ...
    Также в этом случае переопределен operator[]
*/
...
int main()
{
    // Создаём указатель на std::vector:
