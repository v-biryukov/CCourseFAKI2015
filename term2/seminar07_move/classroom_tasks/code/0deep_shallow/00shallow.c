/*
    ...
    В языке C можно копировать структуры также как и базовые типы с помощью оператора присваивания (=). 
    Но при таком копировании копируются только поля структуры, а ресурсы, связанные с этой структурой не копируются.
