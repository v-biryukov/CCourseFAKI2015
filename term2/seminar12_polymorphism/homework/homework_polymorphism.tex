...
\title{Семинар \#11: Полиморфизм. Домашнее задание.\vspace{-5ex}}\date{}\maketitle
\section*{Арканоид. Описание классов игры}
В папке \texttt{arkanoid} лежит заготовка игры Arkanoid, написанная на \texttt{C++} с помощью библиотеки SFML.
Ваша задача заключается в том, чтобы доработать эту игру, добавив различные виды бонусов, блоков, шариков и ракеток.
Классы программы:
\begin{itemize}
