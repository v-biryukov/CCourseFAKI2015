/*
    ...
    В этом случае мы не хотим менять принимаемый объект, так как он может быть использован вне этой функции. 
    Поэтому придётся скопировать его с помощью operator=
