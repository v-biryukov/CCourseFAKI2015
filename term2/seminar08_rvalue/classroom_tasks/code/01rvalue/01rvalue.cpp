/*
    ...
    Самое главное, что нужно понимать об rvalue ссылках это то, что они очень похожи на lvalue-ссылки.
    Разница между этими типами ссылок:

        1)  rvalue-ссылки инициализируются только rvalue выражениями
        2)  можно сделать перегрузку функций по категории значения (lvalue или rvalue)
*/
