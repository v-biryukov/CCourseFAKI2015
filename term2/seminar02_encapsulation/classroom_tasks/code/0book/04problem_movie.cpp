/*
    Задачи: Представлена структура Movie, описывающая фильм на Кинопоиске
        ...
        1)  Напишите метод setReleaseYear, который будет принимать число и устанавливать новой год выхода фильма, 
            равным этому числу. Этот метод не должен ничего возвращать.
