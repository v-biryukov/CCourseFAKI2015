...
/*
    ...
    Такие функции, называются методами, а структура, содержащая методы, может называться классом

    Вызов методов происходит также как и доступ к полям (через точку)

    Обратите внимание что, так как методы структуры Point видят поля x и y, то в методы не нужно передавать саму структуры, 
