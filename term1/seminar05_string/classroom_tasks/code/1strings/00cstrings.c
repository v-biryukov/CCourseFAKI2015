/*
    ...
    а остальные числа забивают нулями.
    Выражение  "MIPT"  называется строковым литералом.
    
    Обратите внимание, что в конце каждой строки мы ставим символ с кодом 0.
    Благодаря этому символу мы можем знать где строка заканчивается, то есть длину строки.
    Длину строки следует отличать от размера массива, в котором она хранится.
