/*
    ...
    Много ошибок возникают у студентов при работе с Терминалом и компиляции и запуске программы.
    ...
    Вот какие ошибки могут возникать при этом:
        ...
        1)  Вы находитесь не в той папке
            ...
            Чтобы понять в какой папке вы находитесь в Терминале можно использовать команду  pwd
