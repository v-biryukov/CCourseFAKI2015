...
int main()
{
    ...
    float c = 3.14159265;  // float занимает 4 байта
...
-->              Для печати символа используйте %c
    */
    ...
    /*
--> Задание 2  - Создайте указатель на int* под названием pincepton, приравняйте его адресу p
                          (то есть указатель на указатель на int)
                 Используйте pinception, чтобы изменить переменную b, присвойте b значение 42
    */
