...
int dynarray_get(const Dynarray* d, int index) {
	return d->values[index];
}

void dynarray_set(Dynarray* d, int index, int value) {
...
int main() {
	// Создаём массив по имени nums размером 1000 элементов в куче
	Dynarray nums;
