/*
    ...
    Представьте массив из 5 миллиардов элементов типа float. Размер такого массива будет 20 миллиардов.
    ...
    Обычно размер size_t - 8 байт. Но размер типа size_t может различаться в зависимости от вычислительной системы.
    На менее мощных системах size_t может иметь размер в 4 байта или даже 2 байта.
