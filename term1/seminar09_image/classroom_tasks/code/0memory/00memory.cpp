/*
    ...
    Более удобно использовать беззнаковое однобайтовое число, так как в этом случае значение каждого байта 
    ...
    Остаются типы unsigned char и uint8_t. В дальнейшем будем использовать тип unsigned char.


    Такми образом, если мы, например, хотим работать с куском памяти, размеров в 5 байт, то нам нужно создать такой массив:
